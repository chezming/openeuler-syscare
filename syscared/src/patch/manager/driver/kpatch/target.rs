...
use crate::patch::manager::entity::KernelPatchSymbol;
...
impl PatchTarget {
    fn match_record(record: &PatchTargetRecord, uuid: &String, symbol: &KernelPatchSymbol) -> bool {
...
impl PatchTarget {
    ...
    pub fn add_symbols<'a, I>(&mut self, uuid: String, symbols: I)
    where
        I: IntoIterator<Item = &'a KernelPatchSymbol>,
    {
        for symbol in symbols {
    ...
    pub fn remove_symbols<'a, I>(&mut self, uuid: &String, symbols: I)
    where
        I: IntoIterator<Item = &'a KernelPatchSymbol>,
    {
        for symbol in symbols {
